...
# Generated by GNU Autoconf 2.69 for rsync 3.1.3dev.
#
...
PACKAGE_VERSION='3.1.3dev'
PACKAGE_STRING='rsync 3.1.3dev'
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
\`configure' configures rsync 3.1.3dev to adapt to many kinds of systems.
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of rsync 3.1.3dev:";;
   esac
  cat <<\_ACEOF
...
It was created by rsync $as_me 3.1.3dev, which was
...
ac_log="
This file was extended by rsync $as_me 3.1.3dev, which was
generated by GNU Autoconf 2.69.  Invocation command line was
